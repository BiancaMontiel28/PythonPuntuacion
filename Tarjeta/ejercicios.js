...
function canBuyProduct() {
    const producto = 1500 * (1 - 0.25);
    const dinerodispo = 1150;
    console.log(dinerodispo >= producto ? "Puedes comprar el producto." : "No puedes comprar el producto.");
...
function logMessage() {
    console.log ("Voy entendiendo de a poco");
}
